...
describe('Live API Integration Tests', () => {
  ...
  describe('Auth Endpoints', () => {
    ...
    test(
      'POST /auth/login - Login with correct credentials',
      skip(async () => {
    ...
    test(
      'POST /auth/login - Fail with incorrect password',
      skip(async () => {
        const res = await request('POST', '/auth/login', {
          email: testEmail,
  ...
  describe('User Profile Endpoints', () => {
    ...
    test(
      'POST /users/measurements - Add body measurement',
      skip(async () => {
        if (!testToken) return;
        const res = await request(
          'POST',
    ...
    test(
      'GET /users/measurements - Get user measurements',
      skip(async () => {
        if (!testToken) return;
    ...
    test(
      'POST /users/privacy - Update privacy settings',
      skip(async () => {
        if (!testToken) return;
        const res = await request(
          'POST',
  ...
  describe('Nutrition Endpoints', () => {
    ...
    test(
      'POST /nutrition/logs - Create meal log',
      skip(async () => {
        if (!testToken) return;
        const res = await request(
          'POST',
    ...
    test(
      'GET /nutrition/logs - List meal logs',
      skip(async () => {
        if (!testToken) return;
    ...
    test(
      'GET /nutrition/daily-summary - Get daily macro summary',
      skip(async () => {
        if (!testToken) return;
    ...
    test(
      'DELETE /nutrition/logs/:id - Delete meal log',
      skip(async () => {
  ...
  describe('Public Endpoints', () => {
    test(
      'GET /programs - Get fitness programs',
      skip(async () => {
  ...
  describe('Password & Email Operations', () => {
    test(
      ...
      skip(async () => {
        const res = await request('POST', '/auth/request-password-reset', {
          email: testEmail,
        });
